...
<head>
  ...
  <title>Cockpit Cosmique Universel</title>
...
<body>
  <header>
    <div class="mono">⚡ Cockpit Cosmique Universel ⚡</div>
    <div class="actions">
  ...
  <main>
    <!-- Vitesse / GPS -->
    <section class="card">
      <h3>⏱️ Vitesse & Temps</h3>
      <div class="metric"><strong>Instantanée:</strong> <span id="speed">-- km/h</span></div>
      <div class="metric"><strong>Moyenne:</strong> <span id="avgSpeed">-- km/h</span></div>
      <div class="metric"><strong>Max:</strong> <span id="maxSpeed">-- km/h</span></div>
      <div class="metric"><strong>Durée:</strong> <span id="duration">-- s</span></div>
      <div class="metric"><strong>Distance:</strong> <span id="distance">-- m</span></div>
      <div class="metric"><strong>% Lumière:</strong> <span id="pourcentage-lumiere">--%</span></div>
      <div class="metric"><strong>% Son:</strong> <span id="pourcentage-son">--%</span></div>
    ...
    <!-- Monde souterrain -->
    <section class="card">
      <h3>🌋 Monde souterrain</h3>
      <div class="metric"><strong>Vitesse souterraine:</strong> <span id="vSub">-- km/h</span></div>
    ...
    <section class="card">
      ...
      <div class="metric"><strong>Magnitude lune:</strong> <span id="luneMag">--</span></div>
    ...
    <section class="card">
      ...
      <div id="horloge-minecraft" class="mono">00:00:00</div>
    </section>
    ...
    <section class="card">
      ...
      <div class="metric"><strong>Neige:</strong> <span id="meteoSnow">-- mm</span></div>
    ...
    <section class="card">
      <h3>🧭 Orientation</h3>
      <div class="metric"><strong>Cap:</strong> <span id="cap">--°</span></div>
      <div class="metric"><strong>Latitude:</strong> <span id="latitude">--</span></div>
      <div class="metric"><strong>Longitude:</strong> <span id="longitude">--</span></div>
      <div class="metric"><strong>Cap vers destination:</strong> <span id="cap-destination">--°</span></div>
      <div class="row"><button onclick="allerVersDestination()">Aller</button></div>
    </section>

    <!-- Capteurs -->
    <section class="card">
      <h3>📐 Capteurs</h3>
      <div class="metric"><strong>Niveau à bulle:</strong> <span id="niveau-bulle">--°</span></div>
      <div class="metric"><strong>Lumière:</strong> <span id="lumiere">-- lux</span></div>
      <div class="metric"><strong>Son:</strong> <span id="son">-- dB</span></div>
      <div class="metric"><strong>Fréquence:</strong> <span id="frequence-son">-- Hz</span></div>
    </section>
    ...
    <section class="card">
      ...
      <div class="row"><button id="btnExport">Exporter JSON</button></div>
    </section>
    ...
    <section class="card">
      ...
      <div class="row"><button onclick="dessinerJournalSouterrain()">Visualiser</button></div>
    </section>
  ...
  <!-- Ici tu peux réinjecter tes <script> du deuxième fichier pour GPS, PWA, journaux, visualisations -->
  <script src="./js/app-universel.js" type="module"></script>
</body>
</html>
